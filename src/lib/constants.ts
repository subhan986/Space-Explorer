...
export const INITIAL_CAMERA_POSITION: Vector3 = { x: 0, y: 2000, z: 5000 }; // Adjusted: further back and higher for larger grid
export const GRID_SIZE = 20000; // Increased from 2000
export const GRID_DIVISIONS = 50; // Kept at 50, user may want to increase for denser grid
